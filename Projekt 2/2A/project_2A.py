...
#V dalších 3 blocích kódu je to obdobně jen s rozdílem pozice kostky ve skladu a přičtení hodnoty vyska_kostky do Z pozice pro uložení do věže, abyse kostky pokládaly stále o jednu nahoru (to se zvětšuje o 1 v každém patře)
